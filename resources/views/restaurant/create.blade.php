...
<div class="flex justify-center flex-wrap  p-1 mt-1">
  <div class="text-center">
    <h1 class="mb-1">{{ __("NUEVO PLATO") }}</h1>
  </div>
</div>
<div class="conatiner-ciudades">
  <div class="container">
    <form class="w-full max-w-lg" method="POST" action="{{ route('restaurant.store') }}"
      ...
      <div>
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="w-full px-3">
            ...
            <textarea name="descripcion" value="{{ old("descripcion") }}" rows="3"
              class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          ...
          <div class="w-full px-3">
            ...
            <input name="categoria" id="categoria" value="{{ old("categoria") }}"
              class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
              type="text">
            <p class="text-gray-600 text-xs italic"></p>
            @error("categoria")
